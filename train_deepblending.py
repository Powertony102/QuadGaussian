...
def parse_args():
    ...
    parser.add_argument("--data_path", type=str, 
                       default="/home/jovyan/shared/xinzeli/tandt_db/db",
                       help="DeepBlending 数据集的基础路径")
    parser.add_argument("--output_path", type=str, 
                       default="output/orggs_deepblending",
                       help="输出结果的基础路径")
    
    # wandb 参数
    parser.add_argument("--wandb_project", type=str, default="OG-Quad-DB",
                       help="wandb 项目名称")
